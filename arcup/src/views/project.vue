  ...
  <div>
    ...
    <v-row class="padding-bottom">
      ...
      <v-col class="text-center" cols="12" sm="6" md="3" lg="3">
        ...
        <v-card-text class="text-justify">
          Nos aseguramos de que nuestros servicios cumplan tus expectativas, por
          ello, mantemos una buena y constante comunicación con nuestros
      ...
      <v-col class="text-center" cols="12" sm="6" md="3" lg="3">
        ...
        <v-card-text class="text-justify">
          Gracias a nuestros reportes semanales podemos confirmar o ajustar el
          proyecto para que cumpla con todas tus expectativas.
        </v-card-text>
      </v-col>
      ...
      <v-col class="text-center" cols="12" sm="6" md="3" lg="3">
        ...
        <v-card-text class="text-justify">
          Te orientamos para construir la solución tecnológica que tu necesitas,
          basandonos en tus necesidades y objetivos encontraremos las
          herramientas adecuadas para que tu proyecto digital sea un éxito.
        </v-card-text>
      </v-col>
    </v-row>
      ...
      <v-row class="">
        <v-col class="text-center" cols="12" sm="4" md="4" lg="4">
          <v-card class="mx-auto" max-width="344">
            <v-card-text>
              <div>Tecnologías</div>
              <p class="display-1 text--primary">Front-end</p>
              <p>Cualidades</p>
              <div class="text--primary">
                Diseños 100% responsivos, modernos y validados por el usuario
              </div>
            </v-card-text>
            <router-link
              :to="{ name: 'Technology' }"
        ...
        <v-col class="text-center" cols="12" sm="4" md="4" lg="4">
          <v-card class="mx-auto" max-width="344">
            <v-card-text>
              <div>Tecnologías</div>
              <p class="display-1 text--primary">Back-end</p>
              <p>Cualidades</p>
              <div class="text--primary">
                Conexión a API Rest, consultas seguras y rápidas.
              </div>
            </v-card-text>
            <router-link
              :to="{ name: 'Technology' }"
        ...
        <v-col class="text-center" cols="12" sm="4" md="4" lg="4">
          <v-card class="mx-auto" max-width="344">
            <v-card-text>
              <div>Tecnologías</div>
              <p class="display-1 text--primary">Móviles</p>
              <p>Cualidades</p>
              <div class="text--primary">
                Funcionalidades y diseños enfocados en la productividad del
                usuario
              </div>
            </v-card-text>
            <router-link
